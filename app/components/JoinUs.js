  ...
  return (
    <div className="max-w-[144opx] mx-auto my-28 ">
      <div className="flex justify-center items-center">
        <div className="h-[70vh] relative w-[80vw] rounded-3xl flex justify-center items-center   bg-black text-white  ">
          ...
          <div className="  flex w-full h-full justify-center flex-col items-center ">
            ...
            <p className="text-white silka xl:w-[500px] text-sm  font-medium text-center mt-10 z-50">
